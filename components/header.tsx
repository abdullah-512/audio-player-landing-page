    ...
    <header className="glass-strong border-b border-border sticky top-0 z-50 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button className="hidden md:inline-block px-6 py-2 rounded-lg bg-muted/30 text-foreground hover:bg-muted/50 transition-all duration-300">
            Sign In
          </button>
          <button className="hidden md:inline-block px-6 py-2 rounded-lg bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:scale-105 hover:shadow-lg transition-all duration-300 glow-neon-blue">
            Get Started
          </button>
          <button
